      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {filteredData.map((item) => (
            <Card key={item.RequestID} className="group hover:border-[#635bff]/30 transition-all">
              <div className="p-5">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <h3 className="font-bold text-slate-950 group-hover:text-[#635bff] line-clamp-2">
                      {item.Title}
                    </h3>
